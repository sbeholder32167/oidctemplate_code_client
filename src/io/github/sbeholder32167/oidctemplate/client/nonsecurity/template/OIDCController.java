 ...
 */
package io.github.sbeholder32167.oidctemplate.client.nonsecurity.template;
...
import io.github.sbeholder32167.oidctemplate.client.nonsecurity.OIDCAuthFailureHandler;
 ...
 * Spring Security 의존성이 없으므로, Spring Security Package가 없는 경우에도 동작<br>
...
public class OIDCController implements OIDCEndpointsInterface {
    ...
    private static final String REDIRECT_URI = "/oidc_template_ns/oidc_code.do";
    ...
    @Override
    @RequestMapping(path="/oidc_template_ns/oidc.do",method = RequestMethod.GET)
    ...
    public void processOidcAuth(HttpServletRequest request, HttpServletResponse response)  throws IOException{
        ...
        Object legacySessionObj;
        try {
            legacySessionObj = this.authConvertAdapter.buildAuthenticationUsingToken(tto);
        ...
        //-- Legacy Session 처리
        this.sessionManager.registerLegacySession(request, response, legacySessionObj);
        LogUtil.info("Legacy Session established.", this);
        try {
            this.successHandler.onAuthenticationSuccess(request, response, legacySessionObj);
     ...
     */
    @Override
    @RequestMapping(path="/oidc_template_ns/logout.do",method=RequestMethod.GET)
     ...
     */
    @Override
    @RequestMapping(path="/oidc_template_ns/logout.do",method=RequestMethod.POST)
     ...
     */
    @Override
    @RequestMapping("/oidc_template_ns/manual_logout.do")
     ...
     * @return 로그 확인.
     */
    @RequestMapping(path="/oidc_template_ns/refresh_token.do",method=RequestMethod.GET)
